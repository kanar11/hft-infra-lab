...
## Why This Matters
In HFT, every memory access matters. A TLB miss or cache miss can add 100ns+ to a hot path. This benchmark measures the real cost of the memory hierarchy on your hardware.

## Method
- Creates a linked list of 64-byte nodes (one cache line each)
- Shuffles pointers randomly to defeat the hardware prefetcher
